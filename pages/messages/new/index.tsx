...
import EmailForm from "@/components/modules/messages/EmailForm";
...
const Messages: NextPage = () => {
  ...
  const [currentView, setCurrentView] = useState('regular')
  ...
  const instantBold = currentView === 'regular' ? 'font-bold' : '';
  const scheduledBold = currentView === 'email' ? 'font-bold' : '';
  ...
  return (
    ...
    <AppLayout>
        ...
        />
        <div className="text-md flex my-3">
