...
import CarRepairLoanTableBodyActiveRow from "@/components/modules/car-repair-loan/CarRepairLoanTableBodyActiveRow";

const CarRepairLoanActive = () => {
    ...
    const headCellData = [
        ...
        { title: "Amount Owed", flex: 1 },
        { title: "Amount Paid", flex: 1 },
        { title: "Date Initiated", flex: 1 },
        { title: "Status", flex: 1 }
    ];

    const { data, isLoading, isError, refetch } = useGetAllCarRepairLoanQuery(
        { limit: 10, page: currentPage, status: 'active' },
        ...
        <>
            ...
            <AppLayout>
                ...
                <EnhancedTable
                    ...
                    rowComponent={(rows) => <CarRepairLoanTableBodyActiveRow data={rows} currentPage={currentPage} />}
                    rowData={data?.data}
                    maxWidth="100vw"
                    isLoading={false}
                    isError={false}
...
export default CarRepairLoanActive;