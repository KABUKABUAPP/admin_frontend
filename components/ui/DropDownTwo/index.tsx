...
const DropDownTwo: FC<Props> = ({ options, value, handleChange, placeholder, left }) => {
  ...
  return (
    <div className="relative cursor-pointer">
      <div className="flex gap-3 items-center" onClick={() => setIsDropDown(!isDropDown)}>
      ...
      {isDropDown && (
        <div
          ref={ref}
          className="bg-[#FFFFFF] rounded-lg p-3 absolute top-6 min-w-[250px] shadow-md"
