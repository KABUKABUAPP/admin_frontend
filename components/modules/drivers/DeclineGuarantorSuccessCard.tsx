...
const DeclineGuarantorSuccessCard: FC = () => {
  ...
  return (
    ...
    >
      <div>
        <p className="text-xs text-center font-semibold">Decline Guarantor</p>
      </div>
      ...
      <div>
        <p className="text-xs text-center font-semibold">
          Guarantor Successfully Declined
        </p>
      </div>
      <div>
        <Button
...
export default DeclineGuarantorSuccessCard;
