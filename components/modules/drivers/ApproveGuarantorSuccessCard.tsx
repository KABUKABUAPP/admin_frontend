...
const ApproveGuarantorSuccessCard: FC = () => {
  ...
  return (
    ...
    >
      <div>
        <p className="text-xs text-center font-semibold">Approve Guarantor</p>
      </div>
      ...
      <div>
        <p className="text-xs text-center font-semibold">
          Guarantor Successfully Approved
        </p>
      </div>
      <div>
        <Button
...
export default ApproveGuarantorSuccessCard;
