...
const BlockDriverSuccessCard: FC = () => {
  ...
  return (
    ...
    >
      <div>
        <p className="text-xs text-center font-semibold">Block Driver</p>
      </div>
...
export default BlockDriverSuccessCard;
