    ...
    >
      <div className="flex flex-col md:flex-row justify-center md:justify-between gap-3">
        <div className="flex mx-6 justify-center mt-1">
          <span className="mx-3 cursor-pointer" onClick={() => {router.push('/staffs')}}><b>Staffs</b></span>
          <span className="mx-3"><b>|</b></span>
          <span className="mx-3 cursor-pointer" onClick={() => {router.push('/staffs/teams')}}>Teams</span>
        </div>
