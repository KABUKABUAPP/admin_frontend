...
const StartSurgeCard: FC<Props> = ({ handleClose }) => {
  ...
  return (
    ...
    >
        ...
        <p className="font-bold text-center text-sm">Are you sure you want to start surge?</p>
        <div className="flex gap-5 w-full flex-wrap justify-center items-center">
            <Button title="Cancel" size="large" color="tetiary"className="w-[43%]" onClick={handleClose}/>
