...
const BlockRiderSuccessCard: FC = () => {
  ...
  return (
    ...
    >
      <div>
        <p className="text-xs text-center font-semibold">Block Rider</p>
      </div>
...
export default BlockRiderSuccessCard;
