...
const CarDocumentUpload: React.FC<Props> = ({ title, handleChange, docImage, docType }) => {
    const [imgUrl, setImgUrl] = useState(docImage);
          ...
          <input
            ...
            onChange={(e) => {
              if (e.target.files) {
                ...
                handleChange({fileUrl: e.target.files[0], docType});
              }
            }}
